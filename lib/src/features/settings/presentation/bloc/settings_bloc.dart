...
import 'package:documents_saver_app/src/features/settings/utils/index_to_locale_variant.dart';
  ...
  SettingsBloc() : super(InitialSettingsState()) {
    ...
    on<SetInitialSettingsEvent>((event, emit) async {
      try {
        ...
        LocaleSettings.setLocale(indexToAppLocale(initalLocale.index),
    ...
    on<SetLocaleSettingsEvent>((event, emit) async {
      try {
        ...
        LocaleSettings.setLocale(indexToAppLocale(locale.index));
